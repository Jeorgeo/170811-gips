...
function gipspanels_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'gipspanels' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'gipspanels' ),
...
function gipspanels_scripts() {
	...
	wp_enqueue_script( 'gipspanels-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
