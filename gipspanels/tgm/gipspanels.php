...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/lib/plugins/wordpress-seo.4.8.zip', // The plugin source.
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/lib/plugins/cyr3lat.3.5.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/lib/plugins/wp-super-cache.1.4.9.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			'name'               => 'add-to-cart-button-custom-text', // The plugin name.
			'slug'               => 'add-to-cart-button-custom-text', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/plugins/add-to-cart-button-custom-text.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'             => get_stylesheet_directory() . '/lib/plugins/woocommerce.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			'name'               => 'woocommerce-customizer', // The plugin name.
			'slug'               => 'woocommerce-customizer', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/plugins/woocommerce-customizer.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
			'version'            => '2.5', // E.g. 1.0.0. If set, the active plugin must be this version or higher. If the plugin version is higher than the plugin version installed, the user will be notified to update the plugin.
			'force_activation'   => true, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
			'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.
